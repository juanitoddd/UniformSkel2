        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <ul id="itemstate">
                        <li><?php echo "<?php echo \$this->Html->link(\$this->Html->tag('span', '1 ' . __('{$singularHumanName}')), array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('escape'=>false));?>"?></li>
                        <li class="first"><span><?php echo "<?php echo \$this->Html->link( '2 ' . __('Images'), array('action' => 'images', \${$singularVar}['{$modelClass}']['{$primaryKey}']));?>";?></span></li>
                        <li class="current"><span><?php echo "<?php echo '3 ' . __('Review');?>";?></span></li>
                    </ul>
                </div>
...
echo "\t\t\t\t\t\t\t<tr>\n";
echo "\t\t\t\t\t\t\t\t<td><?php echo \${$otherSingularVar}['info'];?></td>\n";
echo "\t\t\t\t\t\t\t\t<td><img src='/img/dyn/200/200/0/0<?php echo \${$otherSingularVar}['file'];?>'></td>\n";
