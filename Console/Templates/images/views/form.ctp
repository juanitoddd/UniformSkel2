        ...
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <?php if(strpos($action, 'add') !== false) { //Add ?>
                        <ul id="itemstate">
                            <li class="current-first"><span><?php echo "<?php echo '1 ' . __('{$singularHumanName}');?>"?></span></li>
                            <li><span><?php echo "<?php echo '2 ' . __('Images');?>";?></span></li>
                            <li><span><?php echo "<?php echo '3 ' . __('Review');?>";?></span></li>
                        </ul>
                    <?php }else{ //Edit ?>
                        <ul id="itemstate">
                            <li class="current-first"><span><?php echo "<?php echo '1 ' . __('{$singularHumanName}');?>"?></span></li>
                            <li><span><?php echo "<?php echo \$this->Html->link( '2 ' . __('Images'), array('action' => 'images', \${$singularVar}['{$modelClass}']['{$primaryKey}']));?>";?></span></li>
                            <li><span><?php echo "<?php echo \$this->Html->link( '3 ' . __('Review'), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}']));?>";?></span></li>
                        </ul>
                    <?php } ?>
                </div>
