...
<?php  echo "\n\tvar \$actsAs = array(
        ...
        'Translate',
        'Search.Searchable',
        //'Tags.Taggable', TODO:Dump Tags table to DB
        //'SoftDelete'
    );";
?>
...
<?php  echo "\n\tpublic \$filterArgs = array(
        'id' => array('type' => 'value'),
        'created'=> array('type' => 'query', 'method' => 'datetimeCondition', 'field' => 'created'),
        'modified'=> array('type' => 'query', 'method' => 'datetimeCondition', 'field' => 'modified')
    );";
